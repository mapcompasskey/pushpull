...
.defines(function() {
    EntityPlayer = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            this.addAnim( 'push', 0.5, [32, 33, 34, 33] );
        ...
        checkStatus: function() {
            ...
            if ( ! this.hurting && ! this.dying && ! this.pulling ) {
        ...
        isCrouching: function() {
            ...
            if ( this.hurting || this.dying || this.jumping || this.falling || this.attacking || this.pulling ) {
                return;
            }
        ...
        isPulling: function() {
            ...
            /*
            if ( this.pulling && this.entityPulling ) {
                ...
                if ( this.pos.x < this.entityPulling.pos.x ) {
                    if ( ig.input.state('left') ) {
                        this.pos.x -= mx;
                        this.entityPulling.pos.x -= mx; // move to the left
                    }
                }
                
                // else, the player is pulling from the right side
                else if ( this.pos.x > this.entityPulling.pos.x ) {
                    if ( ig.input.state('right') ) {
                        this.pos.x += mx;
                        this.entityPulling.pos.x += mx; // move to the right
                    }
                }
            ...
            if ( this.pulling && ig.input.released('attack') ) {
                this.pulling = false;
                this.entityPulling = false;
            }
            
            // if attack button pressed while pushing
            ...
            */
            ...
            if ( this.pushing && ig.input.pressed('attack') ) {
                if ( this.pushingEntity ) {
                    this.pulling = true;
                    this.pullingEntity = this.pushingEntity;
                }
            }
        ...
        isJumping: function() {
            ...
            if ( this.hurting || this.dying || this.crouching || this.pulling ) {
                this.jumping = false;
                this.falling = false;
                return;
            }
